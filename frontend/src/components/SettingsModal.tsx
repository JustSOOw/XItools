...
// 设置分类
type SettingsCategory = 'appearance' | 'language' | 'general' | 'about';
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <div className="text-sm text-text-secondary">
                  <p>{t('settings:language.autoDetect')}: {t('common:actions.enable')}</p>
                  <p className="mt-1">
                    {t('settings:language.availableLanguages')}: 中文, English
                  </p>
                </div>
              </div>
            </div>
