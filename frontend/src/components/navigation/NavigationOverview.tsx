          ...
          <div className="h-full overflow-y-auto p-6 custom-scrollbar">
            <div className="max-w-4xl mx-auto animate-fade-in">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div className="bg-surface rounded-lg p-6 border border-border animate-slide-up stats-card" style={{animationDelay: '0.1s'}}>
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-text-secondary">{t('navigation.boards', { defaultValue: '看板' })}</p>
                    </div>
                  </div>
                </div>

                <div className="bg-surface rounded-lg p-6 border border-border animate-slide-up stats-card" style={{animationDelay: '0.2s'}}>
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-text-secondary">{t('navigation.completedTasks', { defaultValue: '已完成任务' })}</p>
                    </div>
                  </div>
                </div>

                <div className="bg-surface rounded-lg p-6 border border-border animate-slide-up stats-card" style={{animationDelay: '0.3s'}}>
                  <div className="flex items-center">
                    ...
                    <div>
                      <p className="text-2xl font-bold text-text-primary">0</p>
                      <p className="text-text-secondary">{t('navigation.pendingTasks', { defaultValue: '待处理任务' })}</p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                {projectBoards.length > 0 ? (
                  ...
                  <div className="text-center py-12">
                    ...
                    <p className="text-text-secondary">
                      {t('navigation.createFirstBoard', { defaultValue: '创建第一个看板开始管理任务' })}
                    </p>
                  </div>
                )}
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div className="bg-surface rounded-lg p-6 border border-border animate-slide-up stats-card" style={{animationDelay: '0.1s'}}>
                  <div className="flex items-center">
                    ...
                    <div>
                      <p className="text-2xl font-bold text-text-primary">{workspaceProjects.length}</p>
                      <p className="text-text-secondary">{t('navigation.projects', { defaultValue: '项目' })}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-surface rounded-lg p-6 border border-border animate-slide-up stats-card" style={{animationDelay: '0.2s'}}>
                  <div className="flex items-center">
                    ...
                    <div>
                      <p className="text-2xl font-bold text-text-primary">{workspaceBoards.length}</p>
                      <p className="text-text-secondary">{t('navigation.directBoards', { defaultValue: '直属看板' })}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-surface rounded-lg p-6 border border-border animate-slide-up stats-card" style={{animationDelay: '0.3s'}}>
                  <div className="flex items-center">
                    ...
                    <div>
                      <p className="text-2xl font-bold text-text-primary">{workspaceProjects.length + workspaceBoards.length}</p>
                      <p className="text-text-secondary">{t('navigation.totalItems', { defaultValue: '总项目数' })}</p>
                    </div>
                  </div>
                </div>
              </div>
                      ...
                      <div className="space-y-2">
                        {workspaceBoards.slice(0, 5).map(board => (
                          ...
                          >
                            ...
                            {board.description && (
                              <p className="text-sm text-text-secondary mt-1">{board.description}</p>
                            )}
                          </div>
                        ))}
                      </div>
